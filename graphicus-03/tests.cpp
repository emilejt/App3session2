...
void Tests::tests_unitaires_canevas()
{
   ...
   /* Canevas can1;
    ...
    can1.coucheAjouter();
    can1.couchePremiere();
    can1.ajouterCercle(2, 2, 2);
    can1.ajouterCarre(6, 9, 2);
    can1.coucheSuivante();
    can1.ajouterRectangle(7, 7, 7, 7);
    cout << "test ajout formes"<<endl;
    can1.afficher(cout);
    can1.formePremiere();
    can1.retirerForme();
    cout << "test retrait forme" << endl;
    can1.afficher(cout);
    can1.coucheAjouter();
    can1.coucheSuivante();
    can1.ajouterCarre(1, 1, 1);
    can1.couchePrecedente();
    can1.coucheRetirer();
    cout << "test retrait couche" << endl;
    can1.afficher(cout);*/
